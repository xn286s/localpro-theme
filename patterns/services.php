...
<div class="wp-block-column"><!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase"},"elements":{"link":{"color":{"text":"var:preset|color|complimentary"}}}},"textColor":"complimentary","fontSize":"label","fontFamily":"display"} -->
<p class="has-text-align-center has-complimentary-color has-text-color has-link-color has-display-font-family has-label-font-size" style="text-transform:uppercase">Fast, Friendly, and Local</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"spacing":{"margin":{"top":"0px"}}},"textColor":"white"} -->
